...
CREATE TABLE
	HR.ORGANIZATIONAL_UNIT (
		/*
		*	UNIQUE FILD
		*/
		ID_ORGANIZATIONAL_UNIT UUID DEFAULT uuid_generate_v4 () PRIMARY KEY,
		/*
		*	FIXED FIELDS
		*/
		ORGANIZATIONAL_UNIT_CODE VARCHAR(10),
		ORGANIZATIONAL_UNIT_NAME VARCHAR(100),
...
ALTER TABLE HR.ORGANIZATIONAL_UNIT
